...
function! s:GetCurlCommand(request)
  ...
  let curlArgs = s:DictToCurlArgs(curlOpts)
...
" @return boolean
"
function! s:DictHasKeys(dictOpts, keys)
  for kk in a:keys
...
"
function! s:DictToCurlArgs(dictOpts)
  let opts = []
