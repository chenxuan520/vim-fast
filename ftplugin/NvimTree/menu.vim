...
func NvimTreeMenu()
	...
	nnoremenu PopUp.VSplite\ File  :lua require('nvim-tree.api').node.open.horizontal()<cr>
	nnoremenu PopUp.Splite\ File   :lua require('nvim-tree.api').node.open.vertical()<cr>
