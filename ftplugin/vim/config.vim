func! VimFastSetPreCode()
	...
	call append( line(".")-1,'"            0 close close' )
	call append( line(".")-1,'"            1 noclose noclose' )
	call append( line(".")-1,'"            2 quickfix : if command is not ok,will stay open or close,' )
	call append( line(".")-1,'"            2 term     : do not open first,after finish,open it,' )
