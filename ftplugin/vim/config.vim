func! VimFastSetPreCode()
	...
	call append( line(".")-1,'" mode     : (new version add)the mode of task,quickfix,term,workflow,')
	call append( line(".")-1,'"            workflow first exec task [begin],and if first exec is ok,exec task [end]')
	call append( line(".")-1,'"            use this mode,fiest exec must be quickfix')
	call append( line(".")-1,'"            mode option is only with:begin,next,name,key')
