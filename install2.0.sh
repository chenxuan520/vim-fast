...
{
    sudo apt-get update
	sudo apt-get install -y cmake vim
    sudo apt-get install -y zip build-essential python python-dev python3-dev fontconfig libfile-next-perl ack-grep git curl wget git
